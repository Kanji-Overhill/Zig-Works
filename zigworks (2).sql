...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-01-2022 a las 08:47:41
...
CREATE TABLE `candidates` (
  ...
  `password_save` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `school` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_legal` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_geo_location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Estructura de tabla para la tabla `eventes`
--
...
--
-- Volcado de datos para la tabla `eventes`
--
...
(4, 'Luis Felipe Hernandez', 'Loremp Ipsum', 'r8J10VdfyZU', '17087117471640134885.jpg', NULL, NULL, 10, 'category_2', 'english', '2021-12-24', NULL, NULL),
(5, 'Conferencia Thomas', 'Loremp Ipsum', 'r8J10VdfyZU', '7340249101640220396.jpg', 0, 1, 10, 'category_1', 'english', '2021-12-05', NULL, '2021-12-23 00:46:36'),
(6, 'Conference Goithom', 'Pruebas', 'r8J10VdfyZU', '8098674211640220722.jpg', 0, 1, 5, 'category_2', 'spanish', '2021-12-31', NULL, '2021-12-23 00:52:02'),
(7, 'Goithom Conference 2', 'Loremp Ipsum', 'r8J10VdfyZU', '5503667851640222189.jpg', 1, 1, 8, 'category_2', 'spanish', '2021-12-28', NULL, '2021-12-23 01:16:30');
...
(5, '2021_11_21_202342_create_employers_table', 1),
(6, '2021_11_21_203219_create_candidates_table', 1),
(7, '2021_12_07_163946_create_events_table', 2);
...
(4, 'Luis', 'speaker', '19628854041640134885.png', 4, NULL, NULL),
(5, 'Felipe', 'host', '4523616631640220396.jpg', 5, NULL, NULL),
(6, 'Jenny', '2', '9772138821640220396.jpg', 5, NULL, NULL),
(7, 'Felipe', 'host', '15996828461640220722.jpg', 6, NULL, NULL),
(8, 'Jenny', 'speaker', '6535163401640220722.jpg', 6, NULL, NULL),
(9, 'Jimena', 'host', '8759671481640222190.jpg', 7, NULL, NULL),
(10, 'Luis', 'speaker', '14470374551640222190.png', 7, NULL, NULL);
...
(1, 'Administrador', 'correo@email.com', NULL, '$2y$10$ccuiP7oq/9LGovGH1TdZKecAowr5hQGv4Yauh/b4njug6eGO1B/g2', NULL, '2021-12-21 22:15:43', '2021-12-21 22:15:43');
...
--
-- AUTO_INCREMENT de la tabla `eventes`
--
ALTER TABLE `eventes`
